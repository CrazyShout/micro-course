...
初始内容快照为 2026-09-15：CS5489 30 节微课 / 326 张卡，CS5222 20 节微课 / 279 张卡。当前 Canvas 内容和往年 Extra Resources 分别标明；AI 讲解不代表教师已确认的考试范围。

## 使用

首页为连续微课；`cards.html` 为卡片阅读器。提示和答案可逐层展开，微课与卡片双向关联。支持英语口述训练、待复习标记及含图片 APKG 下载。

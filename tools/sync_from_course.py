...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='.export-',dir=ROOT) as tmp:
        out=Path(tmp)
        for name in ['learning.css','learning-demos.js','learning-article.css','learning-article-demos.js']:
